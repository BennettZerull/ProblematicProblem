...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write("Hello, welcome to the activity generator! \nWould you like to generate a random activity or look at the list? Generate/List: ");
            bool cont = (Console.ReadLine().ToLower() == "generate")? true: false;
